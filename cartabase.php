		...
		<?php include 'inc/header.php';?>
			...
			<main class="animated slideInLeft">
				...
				<section class="portfolioItem">
					<p class="aboutText">Branding I did for a startup me and a friend worked on that was related to sale and purchase of used cars. This project was later shut down due to lack of time and technical abilities to develop the platform.</p>
				</section>
			</main>
