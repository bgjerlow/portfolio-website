...
<html lang="en">
	<head>
		...
		<title>Bo Gjerlow | MConsult</title>
		...
		<?php include 'inc/header.php';?>
			...
			<main class="portfolioItem animated slideInLeft">
				...
				<img src="img/portfolio/mconsult/mconsult-logo.jpg" class="itemImage itemImageMargin" alt="MConsult logo">
				<p class="itemText">A proposal of a visual identity for a Danish accounting company that specialises in helping small businesses.</p>
				<p class="itemText">This project was done as a part of my educational programme at Business Academy Aarhus.</p>
				
				<h3 class="itemSection">Logo - Concept</h3>
				<p class="itemText">The green squares make up a circle and represent that MConsult handles multiple processes at once by automating various accounting tasks. The 'M' inside the circle is the initial of the founder of MConsult whose name is Mie.</p>
				<p class="itemText">The graph used in the place of the 'L' represents that this is a company that is in the accountant industry.</p>
