		...
		<?php include 'inc/header.php';?>
			...
			<main id="homeContent" class="animated zoomIn">
                <div class="portfolioPreview">
					<a href="spot-festival.php" class="darken"><img src="img/portfolio/spot-festival-preview.jpg" class="previewImage" alt="SPOT Festival website"></a>
				...
				<div class="portfolioPreview middleMargin">
					...
					<h3 class="previewTags">UI/UX design, Web development, Branding</h3>
				</div>
